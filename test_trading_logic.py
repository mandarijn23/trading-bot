#!/usr/bin/env python3
"""Test bot trading logic without live market data"""
...
async def test_position_logic():
    """Test that Position class works with async/await and locks"""
    print("\n" + "="*60)
    ...
    print("\n1️⃣ Testing position.open() with async/lock...")
    await pos.open(
        price=415.00,
        quantity=10.5,
        stop_loss_pct=0.03,
...
if __name__ == "__main__":
    asyncio.run(test_position_logic())
